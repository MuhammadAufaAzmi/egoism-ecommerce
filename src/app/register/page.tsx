...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!/\d/.test(formData.password)) {
      setMessage({ type: "error", text: "Password must contain at least 1 number." });
      return;
    }
    ...
    <div className="bg-surface-container-lowest text-primary min-h-screen flex items-center justify-center px-6 md:px-16 py-24">
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-[10px] uppercase tracking-widest text-secondary font-semibold">OR</span>
          <div className="h-px flex-1 bg-primary/10"></div>
        </div>
